                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('users.new') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control" name="password"
                                        value="{{ session('password') }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control"
                                        name="password_confirmation" value="{{ session('password_confirm') }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="type" type="text" class="form-control" name="type"
                                        value="{{ session('type') == 0 ? 'Admin' : 'User' }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="text" class="form-control" name="address"
                                        value="{{ session('address') }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    @if (session('image'))
                                        <img src="{{ asset('storage/' . session('image')) }}" alt="Profile Image"
